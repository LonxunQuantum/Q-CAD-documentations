...
.. note::
   1. LDAU_PSP(i): specifies DFT+U method, LDAU_PSP2 means add U for Ni element. LDAU_L: selects l quantum number for which on site interaction is added; Hubbard_U: the strength of the effective on-site Coulomb interactions.
...
`Ni_DFT_U_Calculation <examples/Ni_DFT_U_Calculation.tar.gz>`_
